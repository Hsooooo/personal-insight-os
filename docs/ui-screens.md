...
| 항목 | 내용 |
|------|------|
| **목적** | 운등 기록 목록 조회, 필터, 페이징, 태그 관리, 수동 웨이트 입력 |
...
| 항목 | 내용 |
|------|------|
| **목적** | 자연어로 데이터에 질문하고 근거 기반 답변 받기 |
| **구성** | 샘플 질문 버튼 + 채팅 UI + 근거/신뢰도/피드백 |
| **API 호출** | `POST /api/ask` |
| **특징** | Evidence-first RAG, 신뢰도 표시, 피드백 4단계 |
