...
| **Overview** | 선택 cycle의 수입, 이체 제외 External Cash Out, Deferred Spending, Actual Spending, Net External Cashflow, 카테고리별 지출과 원형 Category Mix, 은행/현금/목적자금 Account Flow, 소액결제/후불 Liability Flow 요약. Flow 영역은 긴 금액/계좌명을 위해 별도 row와 고정 컬럼으로 표시 |
